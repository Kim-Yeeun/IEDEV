	...
	<div class="container">
		...
		<form action="modify" method="post" id="modifyForm">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="birth" value="${portfolio.birth}" placeholder="생년월일을 입력해주세요.">
			</div>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="certificate" value="${portfolio.certificate}" placeholder="보유 자격증을 입력해주세요.">
			</div>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="project" value="${portfolio.project}" placeholder="Github 주소를 입력하거나 블로그 주소를 입력해주세요.">
			</div>
			
			<div class="form-group">
				<label for="introduce">자기소개</label>
				<input type="text" class="form-control" name="introduce" value="${portfolio.introduce}" placeholder="간단히 자기소개를 해주세요.">
			</div>
